...
const DEFAULTS: KmindZenViewModesDefaults = {
  zenMode: false,
  readOnly: false,
...
let current: KmindZenViewModesDefaults = { ...DEFAULTS };
...
function parse(text: string): KmindZenViewModesDefaults | null {
  try {
    ...
    return {
      zenMode: typeof viewModes?.zenMode === "boolean" ? viewModes.zenMode : DEFAULTS.zenMode,
      readOnly: typeof viewModes?.readOnly === "boolean" ? viewModes.readOnly : DEFAULTS.readOnly,
      showAddChildButton: typeof nodeEntryControls?.showAddChildButton === "boolean" ? nodeEntryControls.showAddChildButton : DEFAULTS.showAddChildButton,
      showNodeMenuTrigger: typeof nodeEntryControls?.showNodeMenuTrigger === "boolean" ? nodeEntryControls.showNodeMenuTrigger : DEFAULTS.showNodeMenuTrigger,
      imageCompressionEnabled: typeof imageCompression?.enabled === "boolean" ? imageCompression.enabled : DEFAULTS.imageCompressionEnabled,
    };
  } catch {
    return null;
  }
