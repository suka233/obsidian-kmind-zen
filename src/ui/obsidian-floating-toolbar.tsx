...
export function ObsidianFloatingToolbar(props: {
  ...
  const saveLabels = {
    saving: t("appPage.floatingToolbar.saveBadge.saving"),
    saveFailed: t("appPage.floatingToolbar.saveBadge.saveFailed"),
    unsaved: t("appPage.floatingToolbar.saveBadge.unsaved"),
    saved: t("appPage.floatingToolbar.saveBadge.saved"),
  };
    ...
    <div ref={rootRef} className={["kmind-zen-floating", isCompact ? "kmind-zen-floating--compact" : ""].filter(Boolean).join(" ")}>
      <div className={["kmind-zen-bar", "kmind-zen-bar--top", zenMode ? "kmind-zen-bar--hidden" : ""].filter(Boolean).join(" ")}>
        ...
        {isCompact ? (
          <WorkspaceActivityStatus
            app={props.app}
            className="kmind-zen-badge"
            compact
            operation={props.snapshot.editor.clipboard.operation}
            reserveSpace={false}
